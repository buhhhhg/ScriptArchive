...
--[[
https://web.archive.org/web/20231105170900/https://raw.githubusercontent.com/topitbopit/rblx/main/ui-stuff/jeff_2.lua
Made by topitbopit (https://github.com/topitbopit)
Archived at 10/25/2025 (October 25, 2025)
]]

_G.J2DEBUG = false

local s, eventlistener = pcall(function()
    return loadstring(game:HttpGet('https://raw.githubusercontent.com/topitbopit/rblx/main/rbxevent.lua'))()
end)

if not s then
  print("This script cannot be used because 1 library used was not found (deleted)")
  return
end
